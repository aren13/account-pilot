...
from mailpilot.imap import ConnectionError as ImapConnectionError
...
if TYPE_CHECKING:
    ...
    from mailpilot.imap.sync import SyncEngine
...
class IdleListener:
    ...
    def _has_new_mail(self, idle_response: object) -> bool:
        ...
        if hasattr(idle_response, "lines"):
            lines = idle_response.lines  # type: ignore[union-attr]
