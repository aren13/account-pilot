...
from mailpilot.imap import AuthenticationError, ConnectionError, ImapError  # noqa: A004
from mailpilot.providers import get_provider
...
class ImapClient:
    ...
    def provider(self) -> Provider:
        """The :class:`~mailpilot.providers.Provider` for this client."""
